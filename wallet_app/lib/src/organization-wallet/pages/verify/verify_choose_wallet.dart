...
class VerifyChooseWallet extends StatefulWidget {
  ...
  const VerifyChooseWallet({super.key, required this.qrCodeData});
                    ...
                    onPressed: selectedWalletId != null
                        ? () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => VerifyConfirmParty(qrCodeData: widget.qrCodeData),
                              ),
                            );
                          }
                        : null,
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isSelected ? const Color(0xFF0043CE) : const Color(0xFFE0E0E0),
            width: 2,
          ),
