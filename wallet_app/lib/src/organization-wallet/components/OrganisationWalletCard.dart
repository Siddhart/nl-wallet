            ...
            child: Row(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(card.name, style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: card.darkMode ? Color(0xFF152A62) : Colors.white),),
                    Text(card.description, style: TextStyle(fontSize: 16, color: card.darkMode ? Color(0xFF152A62) : Colors.white),),
                  ],
                ),
                Container(
